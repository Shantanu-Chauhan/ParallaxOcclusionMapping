...
void Scene::InitializeScene()
{
	...
	Object* room = new Object(QuadPolygons, roomId);
	...
	Texture* walls = new Texture("textures/Standard_red_pxr128.jpg");
	Texture* wallNormal = new Texture("textures/Standard_red_pxr128_normal.jpg");
	Texture* wallHeight = new Texture("textures/Standard_red_pxr128_bmp.jpg");
	...
	objectRoot->add(room, Translate(basePoint.x, basePoint.y-6.0f, basePoint.z+2.0f)* Rotate(0,90.0f));// REMOVE THIS FOR REFLECTIONS
	objectRoot->add(sea);
...
void Scene::DrawScene()
{
	...
	loc = glGetUniformLocation(programId, "heightScale");
